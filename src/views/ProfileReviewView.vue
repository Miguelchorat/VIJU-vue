...
export default {
  ...
  data() {
    return {
      ...
      results: null,
      path: '/perfil/review/',
      API: "https://viju-server.onrender.com/api/v1/auth/reviews/search=-all/id=" + localStorage.getItem('userId'),
      API_SEARCH: "https://viju-server.onrender.com/api/v1/auth/reviews/search=" + this.search + "/id=" + localStorage.getItem('userId')
    }
  },
  mounted() {
    this.callAPI()
  ...
  watch: {
    search: function () {
      this.API_SEARCH = "https://viju-server.onrender.com/api/v1/auth/reviews/search=" + this.search + "/id=" + localStorage.getItem('userId')
      this.callAPI()
    }
  },
  methods: {
