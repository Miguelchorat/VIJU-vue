...
export default {
    data() {
        return {
            ...
            API_REVIEW: "https://viju-server.onrender.com/api/v1/reviews/" + this.$route.params.id,
            API_UPDATE_REVIEW: "https://viju-server.onrender.com/api/v1/auth/reviews/" + this.$route.params.id,
